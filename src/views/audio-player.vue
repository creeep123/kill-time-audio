<template>
  <div class="wrapper" id="audio-player">
    <div class="player">
...
export default {
  ...
  data() {
    return {
      ...
      tracks: [
        {
          name: '校长寄语1 - Chinese Version',
          artist: '选材校长',
          cover:
            'https://gitee.com/yxon123/gitee-sources/raw/master/images//%E5%BE%AE%E4%BF%A1%E5%9B%BE%E7%89%87_20211217170446.jpg',
          source:
